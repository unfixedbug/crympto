      ...
      <div className="flex relative">
        ...
        {toggleMenu && (
          <ul
            ...
            shadow-2xl md:hidden list-none flex flex-col justify-start items-end rounded-md 
            blue-glassmorphism text-white animate-slide-in-right"
          >
